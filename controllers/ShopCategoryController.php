...
class ShopCategoryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ShopCategory']))
		{
			...
			$image_urls = $_POST['ShopCategory']['sub_category_image'];
			$image_urls_array = explode(',',substr($image_urls, 1));
			//Generic::_setTrace($image_urls_array);
			$image_url = json_encode($image_urls_array);
			$model->sub_category_image = $image_url;
			$model->category_slug = Generic::slugToUrl($_POST['ShopCategory']['category_name']);
			$model->sub_category_slug = Generic::slugToUrl($_POST['ShopCategory']['sub_category_name']);
	...
	{
		$dataProvider=new CActiveDataProvider('ShopCategory');
	 ...
	 * @param ShopCategory $model the model to be validated
	 */
