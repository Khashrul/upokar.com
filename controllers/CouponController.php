...
class CouponController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			//Generic::_setTrace($_POST['Coupon']);
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Coupon']))
		{
			...
			if($_POST['Coupon']['status'] == "on"){

				$creation_date = new \DateTime('now', new DateTimezone('Asia/Dhaka'));
				$create_date =  $creation_date->format('d-m-Y H:i:s');
				$after_date = $creation_date->modify('+90 day');
				$after_date = $creation_date->format('d-m-Y H:i:s');
				$model->create_date = $create_date;
				$model->expired_date = $after_date;
