...
$view_url = $baseUrl.'/'.Yii::app()->request->getPathInfo().'/ServiceDetails?';
...
?>
		...
		<section class="service-single">
			<div class="container">
				<div class="row">
					<?php echo $this->renderPartial('../elements/_common_sidebar');?>
					<section class="expart-details">
						<div class="container">
							<div class="row">
								<div class="col-md-8">
									<h3 style="text-transform: uppercase">Completed service</h3>
									<br>
										...
										<?php if(($service_details) && !empty($service_details)){
											foreach($service_details as $individual_service){
												...
												<tr class="">
													...
													<td><a href="<?=$view_url?>InvoiceId=<?=base64_encode($invoice_id)?>">View</a></td>
												</tr>
											<?php }}?>
										</tbody>
									</table>
